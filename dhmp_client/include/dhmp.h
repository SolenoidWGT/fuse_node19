...
// server恢复回调函数
typedef void(*recovery_handler)(int node_id);
 ...
 */
int dhmp_read(void *dhmp_addr, void * local_buf, size_t length, off_t offset);	// WGT
...
int dhmp_write(void *dhmp_addr, void * local_buf, size_t count, off_t offset);	// WGT
